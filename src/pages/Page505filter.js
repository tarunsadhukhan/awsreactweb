  ...
  return (
    <form>
      ...
      <div className="d-flex justify-content-center mt-4">
        <button type="button" className="btn btn-primary" onClick={handleClose} style={{ width: '100px', height: '40px' }}>
          Close
        </button>
        <span style={{ width: '10px' }}></span>
        <button type="button" className="btn btn-success" onClick={() => handleSubmit(formValues)} style={{ width: '100px', height: '40px' }}>
          Submit
        </button>
      </div>
    </form>
